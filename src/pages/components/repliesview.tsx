...
import { FiHeart, FiShare, FiMoreHorizontal } from 'react-icons/fi'
...
const RepliesView = ( data: RepliesWithUsersAndImages ) => {
    ...
    return (
        ...
        {!!data && (Object.values(data).map(({ reply, user }) => {
            return (
                <div key={reply.id} className="m-auto text-left border-b border-stone-300 w-full min-w-full p-4">
